...
import { fuzzProblem, getProblems, judgeProblem } from "../services/problems.service";
  ...
  .openapi(
    createRoute({
          ...
          content: {
            "application/x-www-form-urlencoded": {
              schema: z.object({
                ...
                source: z.string().openapi({ example: "print('Hello World!')" }),
              }),
            }
          }
        }
      ...
      responses: {
        ...
        415: {
          description: "Unsupported Media Type (Expected application/x-www-form-urlencoded)",
          content: {
            "text/plain": {
              schema: z.string(),
            },
